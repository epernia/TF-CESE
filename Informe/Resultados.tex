\chapter{VALIDACIÓN Y RESULTADOS}\label{cap:resultados}
%¿Funca?
...
\begin{itemize}
\item
Ejemplos de aplicaciones Java utilizando periféricos de la EDU-CIAA-NXP mediante la biblioteca desarrollada (sección [\ref{sec:appPeriph}]).
\item
