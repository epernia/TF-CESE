...
En este ejemplo se comprueba HVM en sus dos modalidades. Una con los todos métodos marcados como \textbf{interpretados} (opción por defecto), resultando en los siguientes valores en su compilación:

\begin{itemize}
\item 
\textbf{\textit{text}}: 30716 bytes. Este área muestra el código de programa y datos de solo lectura.
\item 
...
En la otra modalidad se marcan todos los métodos como \textbf{compilados}, obteniéndose:
...
En ambas el tamaño del \textbf{\textit{Heap}} de Java es de 16384, mientras que el \textbf{\textit{Stack}} es de 1024.

\medskip

Típicamente el consumo de memoria Flash en la aplicación está dado por la suma de \textit{text} + \textit{data}, mientras que el consumo de RAM es \textit{data} + \textit{bss}. De esta forma con los métodos interpretados hay un consumo de,
