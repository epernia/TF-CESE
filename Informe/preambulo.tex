...
\usepackage[spanish, es-tabla]{babel} % lo incluí 20-08-2013
...
% Para sacar los encabezados y pies de página en páginas en blanco
\usepackage{emptypage}


% Paquete para código en algún lenguaje de programación
\usepackage{listings} % Include the listings-package, lo incluí 20-08-2013
...
\definecolor{colorUNQUI}{HTML}{AA2E34} %Color del borde sup
%Color UNQ página oficial - rgb(164, 35, 57) -  #A42339
%Color UNQ Eric - rgb(170, 46, 52) - #AA2E34
%Color UNQ Logo de la página - rgb(131, 44, 27) - #832C1B
...
% Renombro Comandos, es por si no está BABEL
...
%\lhead[\thepage]{\emph{\textsc{CAPÍTULO\thechapter. \thesection \ \currenttitle}}}
%\chead{}
...
%\title{
%	Trabajo Final - Ingeniería en Automatización y Control Industrial
%	\begin{center}
%	\includegraphics[width=55mm,height=60mm]{figuras/unq.png}
%	\end{center}
%	\author{Apellido: Pernia\\Nombre: Eric\\Número de legajo: 15925}
%	\date{\empty}
%}
