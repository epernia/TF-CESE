...
\begin{itemize}
\item 
\textbf{Configuración:} donde se asignan en memoria los objetos de la misión. Esto se hace durante el arranque del sistema y no se considera de tiempo crítico.
\item 
