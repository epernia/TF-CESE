...
Este archivo para la plataforma CIAA se nombra \textbf{LPC4337\_natives\_SCJ.c} en la implementación. \textbf{Nótese} que el archivo \textbf{natives\_XX.c} se ha separado en dos archivos en la implementación para mejorar la modularización.
