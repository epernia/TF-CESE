...
HVM genera código ANSI C independiente de la plataforma. Únicamente una pequeña parte de la infraestructura es dependiente de la plataforma. En la figura [\ref{fig:capasHVM}] se da ofrece esquema en capas de HVM.
