\section{Port de HVM a una nueva plataforma de Haedware} \label{sec:disenoPortHvm} 
...
\item
Definir las funciones específicas de la plataforma. HVM aísla estas funciones en dos archivos, \textbf{natives\_XXX.c} y \textbf{XXX\_interrupts.s}.
\item
...
En el archivo \textbf{natives\_XXX.c} deben definirse las siguientes funciones específicas de la plataforma:
...
Para la ejecución de Java SCJ se deben definir, adicionalmente para la plataforma, las siguientes funciones en el archivo \textbf{natives\_XXX.c}:
...
Luego, en el archivo \textbf{XXX\_interrupt.s} deben realizarse tres funciones en \textit{assembler} necesarias para implementar los \textbf{procesos SCJ} y el cambio de \textit{threads} (cambio de contexto).
